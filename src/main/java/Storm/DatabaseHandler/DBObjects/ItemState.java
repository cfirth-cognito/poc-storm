...
public class ItemState {
    private static List<Column> columns = Lists.newArrayList(
            ...
            new Column("state_datetime_local", Types.DATE),
            ...
            new Column("inv_item_class_type_id", Types.VARCHAR),
            new Column("inv_item_state_type_id", Types.VARCHAR),
            new Column("resource_mgmt_id", Types.VARCHAR),
            new Column("schedule_mgmt_id", Types.VARCHAR),
            new Column("state_transition_counter", Types.INTEGER),
            new Column("begin_date_id", Types.INTEGER),
            new Column("eta_start_datetime_local", Types.DATE),
            new Column("eta_end_datetime_local", Types.DATE),
